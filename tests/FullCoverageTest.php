...
class FullCoverageTest extends TestCase
{
    ...
    public function testHandlerServiceImplementedClass(): void
    {
        ...
        $ref = new ReflectionClass(\MF1DD\ObjectBuilder\Tests\ClassBuilder\Helper\Interface\SimpleTestInterface::class);
    ...
    {
        $ref = new ReflectionClass(\MF1DD\ObjectBuilder\Tests\ClassBuilder\Helper\Interface\EmptyTestInterface::class);
    ...
    {
        $result = ObjectBuilder::init(\MF1DD\ObjectBuilder\Tests\ClassBuilder\Helper\Interface\SimpleReturnValueTestInterface::class, [
            'getString' => 'test',
            'getInt' => 42,
            'getFloat' => 3.14,
            'getBool' => true,
    ...
    public function testE2EInterfaceWithObjectReturn(): void
    {
        $result = ObjectBuilder::init(
            \MF1DD\ObjectBuilder\Tests\ClassBuilder\Helper\Interface\SimpleReturnObjectTestInterface::class,
